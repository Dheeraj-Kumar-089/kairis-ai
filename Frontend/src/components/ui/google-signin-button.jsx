...
export default function GoogleSignInButton({ label = 'Continue with Google', className, ...props }) {
    return (
        <a
            ...
            className={cn(
                'flex w-full items-center justify-center gap-3 rounded-[5px] border px-4 py-3 text-sm font-medium transition',
                'border-black/15 bg-white text-zinc-700 hover:bg-zinc-50',
                'dark:border-white/20 dark:bg-[#131314] dark:text-zinc-200 dark:hover:bg-white/5',
                className
            )}
            {...props}
        >
